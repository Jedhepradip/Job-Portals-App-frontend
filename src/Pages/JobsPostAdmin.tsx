...
const Companyesshow: React.FC = () => {
    ...
    return (
        <>
            <div className='grid grid-cols-1 px-6 mt-7 mb-3'>
                ...
                {/* <div className="flex justify-between items-center mb-5 gap-10">
                    <input
                        ...
                        name='email'
                        placeholder='Filter Company name & role'
                        className='px-4 py-2 border border-gray-300 rounded-md focus:ring-black focus:border-black w-full md:w-auto font-serif'
                    />
                    <NavLink to="/AdminCreateCompany">
                        <div className='flex'>
                            <button className='bg-black text-white md:py-2 md:px-6 px-10 py-0 text-lg rounded-lg font-serif hover:bg-gray-800 transition-all flex'>
                                New Jobs
                            </button>
                        </div>
                    </NavLink>
            ...
            {/* {isEditFormVisible && (
                <div className='absolute top-0 right-0 px-10 py-5 shadow-lg rounded-lg bg-white z-50'>
                    <NavLink to="/AdminCompanyEditForm">
                        <span className='flex items-center gap-2 text-black py-2 px-4 rounded-lg shadow-md hover:shadow-lg transition-all font-serif cursor-pointer'>
                            <FiEdit2 className='text-xl' /> Edit
                        </span>
