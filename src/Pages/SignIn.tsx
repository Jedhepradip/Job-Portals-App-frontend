...
//     const [UserEmail, SetEmail] = useState("");
//     const [UserOTP, SetOTP] = useState("");
//     const [loadingSubmit, setLoadingSubmit] = useState(false); // For Continue button
//     const navigate = useNavigate();
//     const { register, handleSubmit, formState: { errors } } = useForm<IFormInput>();
...
//                                     type="password"
//                                     placeholder='@$!%*?&#^'
//                                     className={`w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-black focus:border-transparent outline-none ${errors.password ? 'border-red-500' : ''}`}
//                                 />
//                                 {errors.password && (
//                                     <div className="text-red-500 text-lg font-serif mt-0 text-center">
...
//                             <div>
//                                 <label className='block text-lg font-serif text-gray-700 mb-1'>Role</label>
//                                 <input
//                                     {...register("role", {
...
//                             {OTPShow && (
//                                 <div>
//                                     <label className='block text-lg font-serif text-gray-700 mb-1'>Enter OTP</label>
//                                     <input
//                                         {...register("OTP", {
...
//                                     type='button'
//                                     onClick={SendOtpForEmail}
//                                     className={`w-full inline-flex justify-center px-4 py-2 border border-transparent text-lg font-medium rounded-md text-white bg-purple-600 shadow-sm hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black ${
//                                         loadingOTP ? 'cursor-not-allowed' : ''}`}
//                                     disabled={loadingOTP}
//                                 >
//                                     {loadingOTP ? (
...
//                                 <NavLink to='/' className='font-serif hover:underline'>Forget password?</NavLink>
//                                 <NavLink to='/SignIn' className='font-serif hover:underline'>Don't have an account?</NavLink>
//                             </div>
//                         </div>
//                     </form>
//                 </div>
