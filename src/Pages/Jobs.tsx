      ...
      <div className='bg-gray-300'>
        <div className='grid grid-cols-12 gap-4 p-4'>
          ...
          <div className='md:col-span-3 col-span-12 bg-white p-6 rounded-lg'>
            ...
            <div className='px-3'>
              <input type="radio" id="frontend" name='Location-Filter-Jobs' className='mr-2' />
              <label htmlFor="frontend" className="font-medium">Frontend Developer</label>
            </div>
            <div className='px-3'>
              <input type="radio" id="backend" name='Location-Filter-Jobs' className='mr-2' />
              <label htmlFor="backend" className="font-medium">Backend Developer</label>
            </div>
            <div className='px-3'>
              <input type="radio" id="datascience" name='Location-Filter-Jobs' className='mr-2' />
              <label htmlFor="datascience" className="font-medium">Data Science</label>
            </div>
            <div className='px-3'>
              <input type="radio" id="fullstack" name='Location-Filter-Jobs' className='mr-2' />
              <label htmlFor="fullstack" className="font-medium">FullStack Developer</label>
            </div>
            <div className='px-3'>
              <input type="radio" id="nextjs" name='Location-Filter-Jobs' className='mr-2' />
            ...
            <div className='px-3'>
              <input type="radio" id="salary1" name='Location-Filter-Jobs' className='mr-2' />
              <label htmlFor="salary1" className='font-medium'>0 - 40K</label>
            </div>
            <div className='px-3'>
              <input type="radio" id="salary2" name='Location-Filter-Jobs' className='mr-2' />
              <label htmlFor="salary2" className='font-medium'>42K to 1 lakh</label>
            </div>
            <div className='px-3'>
              <input type="radio" id="salary3" name='Location-Filter-Jobs' className='mr-2' />
