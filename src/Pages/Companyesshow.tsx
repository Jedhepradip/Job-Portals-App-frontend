      ...
      <div className='grid grid-cols-1 px-6 mt-7 mb-3 relative'>
        ...
        <div className="md:px-28 mt-7 mb-3 md:p-0 p-3 flex flex-col md:flex-row justify-between items-center gap-4" >
          ...
          <NavLink to="/CreateCompanyAdmin" >
            <button className='bg-black text-white py-1.5 md:mt-0 mt-2 px-5 md:px-6 md:py-1.5 text-[18px] float-right rounded-lg font-serif'>New Company</button>
          </NavLink>
        </div>
        ...
        {companies?.map((val, index) => (
          <div key={index} className='grid grid-cols-4 text-center items-center py-4 border-b border-gray-200' >
            <h1 className="font-serif text-lg font-medium flex justify-center items-center ">
              <img src={`http://localhost:8000/${val.CompanyLogo}`} alt={`${val.CompanyName} logo`} className='h-12 w-12 rounded-full object-cover' />
            </h1>
...
//   useEffect(() => {
//     const SearchCompany: CompanyData[] = companies.filter((e: CompanyData) =>
//       e.CompanyName.toLowerCase().includes(Company?.toLowerCase() ?? "")
//     );
//     if (SearchCompany.length) {
//       setCompanies(SearchCompany);
//     }
//     if (!Company && CompanyRedux.length) {
//       setCompanies(CompanyRedux);
//     }
//   }, [CompanyRedux, Company, companies]);
...
//   return (
//     <>
//       <div className='grid grid-cols-1 px-4 mt-5 mb-3 relative'>
//         {/* Search input and button */}
//         <div className="md:px-28 mt-7 mb-3 p-3 flex flex-col md:flex-row justify-between items-center gap-4">
//           <input
//             type="email"
//             name='email'
//             placeholder='Search Company By Name '
//             className='px-4 py-2 border w-full md:w-[30%] border-gray-300 rounded-md focus:ring-black font-serif'
//             onChange={(e) => SetCompany(e.target.value)}
//           />
//           <NavLink to="/CreateCompanyAdmin">
//             <button className='bg-black text-white py-2 px-4 md:px-6 rounded-lg font-serif w-full md:w-auto text-center'>
//               New Company
//             </button>
//           </NavLink>
//         </div>
...
//         {/* Table Headers */}
//         <div className="hidden md:grid grid-cols-4 text-center font-serif text-lg font-medium py-3 rounded-lg">
//           <h1>Logo</h1>
//           <h1>Name</h1>
//           <h1>Date</h1>
//           <h1>Action</h1>
...
//         {/* Data Rows */}
//         {companies?.map((val, index) => (
//           <div key={index} className='grid grid-cols-2 md:grid-cols-4 items-center py-4 border-b border-gray-200 gap-4'>
//             <div className="flex justify-center items-center">
//               <img src={`http://localhost:8000/${val.CompanyLogo}`} alt={`${val.CompanyName} logo`} className='h-12 w-12 rounded-full object-cover' />
//             </div>
//             <h1 className='font-serif text-lg font-medium text-center'>{val?.CompanyName}</h1>
//             <h1 className='font-serif text-sm md:text-lg font-medium text-center'>
//               {val?.createdAt ? new Date(val.createdAt).toLocaleDateString() : 'N/A'}
//             </h1>
//             <div className='text-center md:ml-32 ml-14 cursor-pointer' onClick={() => showEditButton(val?._id)}>
//               <BsThreeDots className='text-gray-500 hover:text-black transition-all' />
//               {companyId === val._id && (
//                 <div className="absolute shadow-lg rounded-lg bg-white z-50 mt-3 -ml-10">
//                   <NavLink to={`/EditCompany/${val._id}`}>
